document.addEventListener("DOMContentLoaded", () => {
    fetch('/api/skinrave-leaderboard')
    .then(response => response.json())
    .then(data => {
        const leaderboard = data.referrals;  // Adjust the field names according to the API response from SkinRave
    ...
    .catch(error => console.error("Error fetching SkinRave leaderboard data:", error));
});
